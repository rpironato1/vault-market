  ...
  return (
    <AppLayout>
      <div className="flex flex-col gap-12">
        <header className="relative py-20 px-12 rounded-[40px] bg-gradient-to-br from-prestige-gold/10 to-transparent border border-prestige-gold/10 overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 p-10">
             <Crown className="text-prestige-gold/20" size={120} weight="fill" />
          </div>

          <div className="relative z-10 max-w-2xl">
            <div className="flex items-center gap-3 mb-6">
               <div className="h-2 w-2 rounded-full bg-prestige-gold animate-pulse" />
               <span className="text-[10px] font-black text-prestige-gold uppercase tracking-[0.4em]">Elite Growth Network</span>
            </div>
            <h1 className="text-6xl font-black tracking-tighter mb-6 uppercase text-white leading-[0.9]">
              Torne-se um <br />
              <span className="text-prestige-gold italic">Arquiteto de Rede.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 bg-black/40 border border-white/5 rounded-2xl px-6 py-4 flex items-center justify-between">
                ...
                <button onClick={copyLink} className="text-prestige-gold hover:scale-110 transition-transform">
                  <Copy size={20} weight="bold" />
                </button>
              </div>
              <button className="h-16 px-10 rounded-2xl bg-prestige-gold text-black font-black uppercase tracking-widest flex items-center gap-2 hover:scale-105 transition-transform shadow-glow-gold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-surface-card border border-white/5 rounded-[32px] p-8 flex flex-col gap-6">
               <div className="h-14 w-14 rounded-2xl bg-white/5 flex items-center justify-center text-prestige-gold">
        ...
        <section className="bg-surface-card rounded-[40px] border border-white/5 p-12">
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  tier.active ? "bg-prestige-gold/5 border-prestige-gold/30" : "bg-black/20 border-white/5 opacity-50"
                )}
              >
                <div className="flex items-center gap-6">
                   <div className={cn("h-4 w-4 rounded-full", tier.active ? "bg-prestige-gold shadow-glow-gold" : "bg-zinc-800")} />
                   <span className={cn("font-black tracking-widest text-sm", tier.active ? "text-prestige-gold" : "text-zinc-500")}>{tier.level}</span>
                </div>
